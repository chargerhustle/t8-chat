  ...
  return (
    <TabsContent value="account" className="space-y-8">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <div className="flex flex-col items-start rounded-lg border border-secondary/40 bg-card/30 px-6 py-4">
            <div className="mb-2 flex items-center">
              ...
              <span className="text-base font-semibold">File Attachments</span>
            </div>
            <p className="text-sm text-muted-foreground/80">
          ...
          <div className="flex flex-col items-start rounded-lg border border-secondary/40 bg-card/30 px-6 py-4">
            ...
            <p className="text-sm text-muted-foreground/80">
              Chat with different AI models and find the one that works best for
              you.
            </p>
          </div>
        </div>
      ...
      <div className="md:hidden">
        <UserStatsCard showCustomizeButton={false} userStats={userStats} />
      </div>
