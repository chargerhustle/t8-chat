					...
					<div className="space-y-6">
						...
						<div className="space-y-4 rounded-lg border border-input p-4">
							<div className="flex flex-col space-y-2">
								...
								<p className="text-sm text-muted-foreground">Used for the models of the following providers:</p>
								<div className="flex flex-wrap gap-2">
									<span className="rounded-full bg-secondary px-2 py-1 text-xs">OpenAI</span>
									<span className="rounded-full bg-secondary px-2 py-1 text-xs">Anthropic</span>
									<span className="rounded-full bg-secondary px-2 py-1 text-xs">Google Gemini</span>
									<span className="rounded-full bg-secondary px-2 py-1 text-xs">Llama</span>
									<span className="rounded-full bg-secondary px-2 py-1 text-xs">All other models</span>
								</div>
							</div>
							<div className="space-y-4">
								<div className="space-y-2">
