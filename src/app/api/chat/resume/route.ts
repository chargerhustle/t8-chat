...
export async function GET(req: Request) {
  try {
    ...
    console.log(`[CHAT] Resume request for message: ${messageId}, session: ${sessionId}`)

    console.log(`[CHAT] Attempting to resume stream: ${streamId} from position: ${resumeAt || 'start'}`)
